...
«donde M(q) es la matriz de masas simétrica definida positiva, c(q, q̇) es el vector que contiene los pares de Coriolis y centrífugos y g(q) es el vector de pares gravitatorios» (Lynch y Park, 2017, p. 275, ec. 8.10).
...
def vector_velocidad(q, dq):
    \"\"\"c(q, q̇): términos centrífugos (con q̇i²) y de Coriolis (con q̇1·q̇2),
...
**Coriolis y centrífugas.** Los términos cuadráticos tienen nombre y física propia: «los términos cuadráticos que contienen q̇ᵢ² se llaman términos centrífugos, y los que contienen q̇ᵢ·q̇ⱼ con i ≠ j se llaman términos de Coriolis» (Lynch y Park, 2017, p. 276). Separémoslos numéricamente para ver quién aporta qué."""))
