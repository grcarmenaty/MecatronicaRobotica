...
dem("Parejas, min 32 a 55: cada pareja escribe la ETS, la tabla DH y el par M, S₁, S₂ del 2R del libro (eslabones de 1 m) y verifica las tres en q = (30°, 40°).");
...
hab("Os marco los hitos del cuaderno. Primero, cargad el IRB140 y calculad la pose en qr: os tiene que dar la posición (0,005, 0, 0,332) con esa orientación de menos noventa grados que veis en la diapositiva. Segundo, verificad a mano el producto de la cadena para una configuración: es la misma multiplicación de matrices del viernes, la toolbox solo os ahorra teclearla. Tercero, abrid teach con el PUMA y buscad dos cosas: la muñeca esférica, esos tres ejes que se cortan en un punto, y qué articulaciones mueven mucho el efector y cuáles poco según la postura. Y cuarto, el 6R genérico escrito como ETS, para que veáis que un robot industrial es la receta del martes con una muñeca ZYZ al final.",
